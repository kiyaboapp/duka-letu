...
urlpatterns = [
    ...
    path('generate-now/', views.generate_now, name='generate_now'),
    path('expenses/', views.expense_list, name='expense_list'),
    path('expenses/new/', views.expense_create, name='expense_create'),
    path('expenses/new/recurring/', views.expense_create_recurring, name='expense_create_recurring'),
    path('expenses/new/adhoc/', views.expense_create_adhoc, name='expense_create_adhoc'),
    ...
    path('expenses/<int:pk>/direct-pay/', views.expense_direct_pay, name='expense_direct_pay'),
    path('recurrence/<int:pk>/update/', views.recurrence_update, name='recurrence_update'),
    path('recurrence/<int:pk>/delete/', views.recurrence_delete, name='recurrence_delete'),
